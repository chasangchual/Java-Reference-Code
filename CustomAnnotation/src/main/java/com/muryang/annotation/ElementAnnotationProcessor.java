...
@SupportedAnnotationTypes("main.java.TestElement")
@SupportedSourceVersion(SourceVersion.RELEASE_7)
public class ElementAnnotationProcessor extends AbstractProcessor {
    @Override
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        for(Element e: roundEnv.getElementsAnnotatedWith(TestElement.class)) {
