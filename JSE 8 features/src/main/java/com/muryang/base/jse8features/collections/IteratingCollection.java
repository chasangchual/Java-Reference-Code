...
public class IteratingCollection {
	...
	public static void navigate_v1() {
		for(int i = 0 ; i < friends.size(); i++) {
			System.out.println(friends.get(i)) ;
		}
	}
	
	public static void navigate_v2() {
		for(String friend : friends) {
			System.out.println(friend) ;
		}
	}
	
	public static void navigate_f() {
	...
	public static void navigate_l() {
		// friends.forEach((final String friend) -> System.out.println(friend));
		friends.forEach(friend -> System.out.println(friend));
		
		friends.stream().mapToInt(name -> name.length()).forEach(value -> System.out.println(value)); ;
	}
	
	public static void main(String[] args) {
		IteratingCollection.navigate_l() ;
	}
}
